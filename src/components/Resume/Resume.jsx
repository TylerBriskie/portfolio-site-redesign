        ...
        return (
            <div className="resume-page-container">
                <div className="resume-page-columns">
                    ...
                    <section className="experience">
                        <header>
                            <h1>Harley & The V-Twins <span>2011 - 2013</span></h1>
                        </header>
                        <p>Harley Osterlund is a musician and sound engineer from Ft. Collins, CO that I met in 2011, when I joined his band as a drummer.</p>
                        <p>Over the year and a half I played with Harley, we played probably close to 300 shows, sometimes as many as 6 nights a week, touring all over the great plains states.</p>
